...
parser.add_argument('-o', '--out-suffix', metavar='SUFFIX', type=str, default='tx')
parser.add_argument('-r', '--ref', dest='file_ref', default=None, metavar='REFERENCE')
parser.add_argument('-a', '--absorbance', action='store_true', required=False, default=False)
parser.add_argument('-t', '--transmission', action='store_true', required=False, default=False)
parser.add_argument('-s', '--sub', type=float, required=False, nargs='?',default=0.)
...
# save
    file_out= st.mkdir_suff(args.out_suffix,"tx",base=args.file_in[i],ex=".txt")
