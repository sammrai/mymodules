...
def getparse():
	...
	parser.add_argument('-o', '--out-suffix', metavar='SUFFIX', type=str, default=None)
	parser.add_argument('-s', '--silence', action='store_true', required=False, default=False)
	parser.add_argument('-same', action='store_true', required=False, default=False)
