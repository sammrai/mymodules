...
def get_hsi_wav(filename,wav=None):
    if filename.split(".")[-1] == "float":
        ...
        raise ValueError("Format \"%s\" is not supported."%filename.split(".")[-1]+"\nSupported formats: float, pkl.")
...
if args.transmittance:minn,maxx = 0.,1.
if args.absorbance:minn,maxx = 0.,2.
if args.ymin:minn = args.ymin
if args.ymax:maxx = args.ymax
